...
Patch6: gui_timeout.patch
Patch7: uploads_emit_messages2.patch
Patch8: status_in_rhtsupport.patch
Patch9: redirect.patch
Patch10: rpm_to_c.patch
...
# general patches
%patch6 -p1 -b .timeout
%patch7 -p1 -b .messages_during_upload
%patch8 -p1 -b .updates_from_rhtsupport
%patch9 -p1 -b .redirect
%patch10 -p1 -b .rpm_to_c
